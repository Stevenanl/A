	...
	if not lag then
		local function check(v)
			...
			if v:IsA("Model") then
				...
				elseif ((v.Name == "Candy") or (v.Name == "BatteryPack") or (v.Name == "BandagePack") or (v.Name == "Lighter") or (v.Name == "Lockpick") or (v.Name == "ShieldMini") or (v.Name == "ShieldBig") or (v.Name == "Crucifix") or (v.Name == "SkeletonKey") or (v.Name == "Vitamins") or (v.Name == "Flashlight") or (v.Name == "Shakelight") or (v.Name == "Scanner") or (v.Name == "Glowsticks") or (v.Name == "LaserPointer") or (v.Name == "Shears") or (v.Name == "Bulklight") or (v.Name == "Straplight")) then
					local prompt = v:WaitForChild("ModulePrompt");
					local interactions = prompt:GetAttribute("Interactions");
