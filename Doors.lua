...
local ESP_Items = {GlitchCube={"!! GLITCH CUBE !!",1.5},Smoothie={"Smoothie",1.5},Candy={"Candy",1.5},AlarmClock={"AlarmClock",1.5},AlarmClockModel={"AlarmClock",1.5},BandagePack={"BandagePack",1.5},BatteryPack={"BatteryPack",1.5},KeyObtain={"Key",1.5},FuseObtain={"Fuse",1.5},Glowsticks={"Glowsticks",1.5},Bulklight={"BulkLight",1.5},Straplight={"StrapLight",1.5},LaserPointer={"LaserPointer",1.5},Shears={"Shears",1.5},ShieldMini={"Mini Shield",1.5},ShieldBig={"Big Shield",1.5},StarVial={"Starlight Vial",1.5},LiveHintBook={"Book",1.5},Lighter={"Lighter",1.5},Lockpick={"Lockpicks",1.5},Vitamins={"Vitamins",1.5},Crucifix={"Crucifix",1.5},CrucifixWall={"Crucifix",1.5},SkeletonKey={"Skeleton Key",1.5},Flashlight={"Flashlight",1.5},Candle={"Candle",1.5},LiveBreakerPolePickup={"Fuse",1.5},Battery={"Battery",1.5},PickupItem={"Paper",1.5},ElectricalKeyObtain={"Electrical Key",1.5},Shakelight={"Shakelight",1.5},Scanner={"Scanner",1.5}};
local ESP_Entities = {GlitchRush={"RNIUSHCg==",5},GlitchAmbush={"AR0xMBUSH",5},FigureRig={"Figure",1.5},Grumbo={"Grumble",5},GiggleCeiling={"Giggle",5},RushMoving={"Rush",5},AmbushMoving={"Ambush",5},BackdoorRush={"Blitz",5},FigureRagdoll={"Figure",7},FigureLibrary={"Figure",7},SeekMovingNewClone={"Seek",5.5},SeekMoving={"Seek",5.5},A60={"A-60",10},A120={"A-120",10},Wardrobe={"Wardrobe",5}};
local ESP_Other = {Toolbox_Locked={"Locked Toolbox",5},Locker_Small_Locked={"Locked Locker",5},MouseHole={"Mouse Hole",5},ChestBox={"Chest",5},ChestBoxLocked={"Chest (Locked)",5},Toolshed_Small={"Toolshed",5},Chest_Vine={"ChestVine",5},MinesAnchor={"Anchor",5},Door={"Door",5},LeverForGate={"Lever",3},TimerLever={"Lever",3},GoldPile={"Gold",0.5},Bandage={"Bandage",0.5}};
	...
	if not lag then
		local function check(v)
			...
			if v:IsA("Model") then
				...
				elseif ((v.Name == "Smoothie") or (v.Name == "Candy") or (v.Name == "BatteryPack") or (v.Name == "BandagePack") or (v.Name == "Lighter") or (v.Name == "Lockpick") or (v.Name == "ShieldMini") or (v.Name == "ShieldBig") or (v.Name == "Crucifix") or (v.Name == "SkeletonKey") or (v.Name == "Vitamins") or (v.Name == "Flashlight") or (v.Name == "Shakelight") or (v.Name == "Scanner") or (v.Name == "Glowsticks") or (v.Name == "LaserPointer") or (v.Name == "Shears") or (v.Name == "Bulklight") or (v.Name == "Straplight")) then
					local prompt = v:WaitForChild("ModulePrompt");
					local interactions = prompt:GetAttribute("Interactions");
